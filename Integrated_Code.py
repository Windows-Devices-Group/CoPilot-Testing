...
def get_conversational_chain_generic():
    try:
        prompt_template = """
            ...
            IMPORTANT: Use only the data provided to you and do not rely on pre-trained documents. If the user question is not in the data provided. Just mention - "Not in the context". 
            ...
            Important: Generate outputs using the provided dataset only, don't use pre-trained information to generate outputs.
            If the user question is not in the data provided. Just mention - "Not in the context". Do not answer to questions which are not in the provided dataset.
